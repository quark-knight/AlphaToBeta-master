...
# -------------------------------
#SBATCH -D /storage/aditya/AlphaMut-master/AlphaToBeta_synced
...
export PYTHONPATH="$(dirname "$(pwd)"):$PYTHONPATH" # so 'import Helix_in_protein' works from parent folder
